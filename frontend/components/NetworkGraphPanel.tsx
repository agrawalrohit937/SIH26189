...
export const NetworkGraphPanel: React.FC<NetworkGraphPanelProps> = ({
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 pb-2 border-b border-slate-100 shrink-0">
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            <button
              ...
              title="Toggle Date Range Timeline Filter"
            >
              <SlidersHorizontal className="w-3 h-3 text-amber-500" />
              <span>Timeline {startDate || endDate ? "(Active)" : ""}</span>
            </button>
      ...
      {/* 2. Top Dark Navy Timeline Filter Bar (Clean, Minimal & Strictly Single Line) */}
      {(showTemporalBar || elements.length === 0) && (
        <div className="px-3 py-1.5 rounded-xl bg-[#07172C] text-white flex items-center justify-between gap-3 border border-[#142944] shadow-md shrink-0">
          <div className="flex items-center gap-3">
            <span className="text-[11px] font-black uppercase tracking-wider text-[#F59E0B] flex items-center gap-1.5 shrink-0">
            ...
            <div className="flex items-center gap-2 text-xs">
              ...
              <div className="relative flex items-center bg-[#0D213A] border border-[#1C3A5E] rounded-md px-2 py-0.5 text-xs text-white focus-within:border-[#F59E0B]">
                <input
                  ...
                  className="bg-transparent text-[11px] text-white outline-none font-mono placeholder:text-slate-500 w-[115px] cursor-pointer"
                />
                <Calendar className="w-3 h-3 text-slate-400 ml-1 pointer-events-none" />
              </div>
              <span className="text-[10.5px] text-slate-400 font-medium">To</span>
              <div className="relative flex items-center bg-[#0D213A] border border-[#1C3A5E] rounded-md px-2 py-0.5 text-xs text-white focus-within:border-[#F59E0B]">
                <input
                  type="date"
                  value={endDate}
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="px-3.5 py-1 rounded-md bg-[#F59E0B] hover:bg-[#D97706] text-[#07172C] text-[11px] font-black shadow-sm transition-all cursor-pointer active:scale-95 shrink-0"
            >
              Apply Filter
            </button>
            {(startDate || endDate) && (
              <button
                ...
                className="px-2 py-0.5 rounded bg-rose-900/40 hover:bg-rose-900/60 text-rose-300 text-[10px] font-bold border border-rose-700/50 cursor-pointer shrink-0"
              >
                Clear
              </button>
            )}
